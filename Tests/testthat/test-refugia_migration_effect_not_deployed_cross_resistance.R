...
for(i in 1:11){
  ...
  test_that("No difference when cross selection is zero, coverage", {
    expect_equal(refugia_migration_effect_insecticide_not_deployed(initial.refugia.resistance = 10,
...
for(i in 1:11){
  ...
  test_that("No difference when cross selection is zero, dispersal", {
    expect_equal(refugia_migration_effect_insecticide_not_deployed(exposure.scaling.factor = 10,
                                                                   nsim = 1, 
                                                                   minimum.insecticide.resistance.heritability = 0.30, 
                                                                   maximum.insecticide.resistance.heritability = 0.30,
                                                                   minimum.male.insecticide.exposure = 0.4,
