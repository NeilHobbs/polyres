...
for(i in 1:length(test.values)){
  test_that("min heritability in range",{
    expect_error(insecticide_not_deployed_selection_cost(
      ...
      maximum.male.insecticide.exposure = 1, 
      minimum.female.insecticide.exposure = 0.4, 
      maximum.female.insecticide.exposure = 0.9), "minimum.insecticide.resistance.heritability must be between 0 and 1")})}
...
for(i in 1:length(test.values)){
  test_that("max heritability in range",{
    expect_error(insecticide_not_deployed_selection_cost(
      ...
      maximum.male.insecticide.exposure = 1, 
      minimum.female.insecticide.exposure = 0.4, 
      maximum.female.insecticide.exposure = 0.9), "maximum.insecticide.resistance.heritability must be between 0 and 1")})}
...
test_that("heritability min > max",{
  expect_error(insecticide_not_deployed_selection_cost(
    ...
    maximum.male.insecticide.exposure = 1, 
    minimum.female.insecticide.exposure = 0.4, 
    maximum.female.insecticide.exposure = 0.9), "minimum.insecticide.resistance.heritability is greater than maximum.insecticide.resistance.heritability")})
