...
Test_1 = run_simulation (number.of.insecticides = 3,
...
refugia1 = Test_1["refugia", 1, ] #Refugia, insecticide 1 length 500
refugia2 = Test_1["refugia", 2, ] # Refugia, insecticide 2 length 500
refugia3 = Test_1["refugia", 3, ] #Refugia, insecticide 3 length 500

#Do the same, but for treatment sites
treatment1 = Test_1["treatment", 1, ] #treatment, insecticide 1 length 500
treatment2 = Test_1["treatment", 2, ] # treatment, insecticide 2 length 500
treatment3 = Test_1["treatment", 3, ] #treatment, insecticide 3 length 500
...
Test1_DF = data.frame(generation, location, resistance.intensity, resistance.insecticide, deployed)
...
##Now plot:
ggplot(Test1_DF, aes(x=generation, y = resistance.intensity)) +
  ...
  ggtitle("No Dispersal and No Resistance Costs") +
