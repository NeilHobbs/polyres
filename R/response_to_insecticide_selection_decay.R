#' @title Convert insecticide selection into selection response, using the Breeder's Equation, accounting for insecticide decay
#'
#' @import stats
...
response_to_insecticide_selection_decay = function(exposure.scaling.factor = 10,
                                             nsim = 1000, 
                                             minimum.insecticide.resistance.heritability = 0.05, 
  ...
  resistance.selection.reponse = exposure.scaling.factor*((insecticide.resistance.heritability*female.insecticide.exposure.proportion*(1+male.insecticide.exposure.proportion)*current.insecticide.efficacy)/2)
