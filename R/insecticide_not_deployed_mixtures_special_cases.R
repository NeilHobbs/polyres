...
#This is equation 8a(ii)
insecticide_not_deployed_mixtures_special_cases = function(exposure.scaling.factor = 10,
                                                             nsim = 1000,
  ...
  field.survival.mix.1 = convert_bioassay_survival_to_field_insecticide_decay(bioassay.survival = resistance_to_bioassay_survival(maximum.bioassay.survival.proportion = 1,
  ...
  field.survival.mix.2 = convert_bioassay_survival_to_field_insecticide_decay(bioassay.survival = resistance_to_bioassay_survival(maximum.bioassay.survival.proportion = 1,
                                                            ...
                                                            conversion.factor = conversion.factor,
                                                            intercept = intercept,
                                                            current.insecticide.efficacy = efficacy.part.2)
