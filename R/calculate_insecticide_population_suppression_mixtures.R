...
calculate_insecticide_population_suppression_mixtures = function(minimum.female.insecticide.exposure,
                                                        maximum.female.insecticide.exposure,
                                                        nsim,
                                                        intercept,
                                                        conversion.factor,
                                                        current.insecticide.efficacy.part.1,
                                                        current.insecticide.efficacy.part.2,
                                                        currently.deployed.mixture.part.1,
                                                        currently.deployed.mixture.part.2,
                                                        sim.array,
                                                        current.generation,
  ...
  #Survival to mixture part 1
  #Get the bioassay survival of the intervention site to the currently deployed insecticide. Is current.generation-1.
  intervention.site.bioassay.survival.1 = resistance_to_bioassay_survival(maximum.bioassay.survival.proportion = 1,
                                                                        mean.population.resistance = sim.array['treatment', currently.deployed.mixture.part.1, current.generation-1],
  ...
  intervention.site.field.survival.1 = convert_bioassay_survival_to_field_insecticide_decay(conversion.factor = conversion.factor,
                                                                                          bioassay.survival = intervention.site.bioassay.survival.1,
                                                                                          intercept = intercept,
                                                                                          current.insecticide.efficacy = current.insecticide.efficacy.part.1)
  
  
  #Survival to mixture part 2
  intervention.site.bioassay.survival.2 = resistance_to_bioassay_survival(maximum.bioassay.survival.proportion = 1,
                                                                        mean.population.resistance = sim.array['treatment', currently.deployed.mixture.part.2, current.generation-1],
                                                                        michaelis.menten.slope = 1, 
                                                                        half.population.bioassay.survival.resistance = half.population.bioassay.survival.resistance,
                                                                        sd.population.resistance = 0, 
                                                                        nsim = 1)
  ...
  #Convert to field survival
  intervention.site.field.survival.2 = convert_bioassay_survival_to_field_insecticide_decay(conversion.factor,
                                                                                          bioassay.survival = intervention.site.bioassay.survival.2,
                                                                                          intercept = intercept,
                                                                                          current.insecticide.efficacy = current.insecticide.efficacy.part.2)
  
  
  
  overall.survival = intervention.site.field.survival.1 * intervention.site.field.survival.2
  
  #Then do equation 10(i)::
  proportion.remaining = (1 - female.insecticide.exposure) + (female.insecticide.exposure*overall.survival)
