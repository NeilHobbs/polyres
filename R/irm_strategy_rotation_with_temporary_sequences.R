...
irm_strategy_rotation_with_temporary_sequences = function(number.of.insecticides,
                                                          current.generation,
  ...
  if(length(available.to.deploy)==0){deployment.vector.updated = deploy_insecticide(insecticide.to.deploy = NA,
    ...
    if(candidate.insecticide == current.insecticide){
      deployment.vector.updated = deploy_insecticide(insecticide.to.deploy = candidate.insecticide,
