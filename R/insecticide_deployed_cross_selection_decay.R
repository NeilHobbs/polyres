...
insecticide_deployed_cross_selection_decay = function(currently.deployed.insecticide, #will be deployed.insecticide[generation]
  ...
  response.to.selection = mean(response_to_insecticide_selection_decay(exposure.scaling.factor = exposure.scaling.factor,
                                                                       nsim = nsim, 
