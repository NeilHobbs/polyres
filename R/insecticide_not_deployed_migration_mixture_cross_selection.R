...
insecticide_not_deployed_migration_mixture_cross_selection = function(nsim,
  ...
  refugia.intensity = refugia_selection_costs(initial.refugia.resistance = initial.refugia.resistance,
                                              resistance.cost = resistance.cost[currently.tracked.insecticide],
                                              exposure.scaling.factor = exposure.scaling.factor,
                                              nsim = nsim, 
                                              minimum.insecticide.resistance.heritability = minimum.insecticide.resistance.heritability[currently.tracked.insecticide], 
                                              maximum.insecticide.resistance.heritability = maximum.insecticide.resistance.heritability[currently.tracked.insecticide],
