...
insecticide_not_deployed_migration = function(initial.resistance.intensity,
                                              resistance.cost,
  ...
  selection.cost.site = insecticide_not_deployed_selection_cost(initial.resistance.intensity = initial.resistance.intensity,
  ...
  #Prevent resistance values being lower than 0s
