...
#                              resistance.cost = 0, #Medium resistance.cost (range 0.01 to 0.2)
...
#                              min.dispersal.rate = 0.1, #No Dispersal
#                              max.dispersal.rate = 0.9, #No Dispersal
#                              maximum.generations = 500)#do not change (matches insecticide sequence)
# 
# #get intensities for insecticides based refugia area only
# insecticide1 = simulation1[1,1,]
# insecticide2 = simulation1[1,2,]
# insecticide3 = simulation1[1,3,]
# 
