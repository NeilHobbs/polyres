...
refugia_migration_effect_insecticide_not_deployed_mixture_special_cases = function(exposure.scaling.factor = 10,
  ...
  numerator = (refugia.intensity * staying.in.refugia) + (intervention.intensity * joining.from.intervention)
  denominator = (staying.in.refugia + joining.from.intervention)
