...
refugia_migration_effect_deployed_cross_resistance = function(exposure.scaling.factor = 10,
                                                              nsim = 1000, 
  ...
  treatment.site.selection = insecticide_deployed_indirect_cross_selection(currently.deployed.insecticide = currently.deployed.insecticide,
