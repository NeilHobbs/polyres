#Set 32
#Testing the impact of cross selection in the absence of fitness costs and refugia 
...
write.csv(sequence.df.cross.1, ".//sequence.set.32.csv")
...
write.csv(rotation.df.cross.1, ".//rotation.set.32.csv")
...
write.csv(mixture.df.1, ".//mixtures.set.32.csv")
