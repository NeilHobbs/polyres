...
temp.list.rotation.10 = list() #create empty list to hold the loop

#First run for rotations [45000 runs] #24833 
#;40731
#resume at 44286
for(v in 1:nrow(parameter.space)){
  ...
  temp.list.rotation.10[[v]] = temp_2
}

#Convert to a single dataframe
rotation.df.set10 = do.call(rbind, temp.list.rotation.10)
rotation.df.set10.complete = cbind(rotation.df.set10, parameter.space)

write.csv(rotation.df.set10.complete, ".//rotation.set.10.csv")
