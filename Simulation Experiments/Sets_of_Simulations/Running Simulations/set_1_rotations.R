...
rotation.df.set1 = do.call(rbind, temp.list.rotation)
rotation.df.set1.complete = cbind(rotation.df.set1, parameter.space)

write.csv(rotation.df.set1.complete, ".//rotation.set1.csv")
