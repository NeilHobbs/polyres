#Set 9: Mixtures, Cross Resistance
...
for(v in 1:nrow(parameter.space.df)){
  ...
  temp.list.mixtures.set.9[[v]] = temp_2
}

mixture.df.set.9 = do.call(rbind, temp.list.mixtures.set.9)
mixture.df.set.9.1 = cbind(mixture.df.set.9, parameter.space.df)

write.csv(mixture.df.set.9.1, ".//mixtures.set.9.csv")
