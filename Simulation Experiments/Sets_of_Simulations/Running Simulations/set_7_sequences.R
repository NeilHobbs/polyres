#Set 7:Sequences::: The return threshold has been increased from 5% to 9%. 
...
sequence.df.set7 = do.call(rbind, temp.list.sequence)
sequence.df.set7.complete = cbind(sequence.df.set7, parameter.space)

write.csv(sequence.df.set7.complete, ".//sequence.set7.csv")
