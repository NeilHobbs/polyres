#Looking at the impact of allowing insecticide decay and population suppression and cross selection
...
write.csv(seq.rot.df, ".//set.22.rotations.sequences.csv")
...
write.csv(mixture.df.1, ".//set.22.mixtures.csv")
