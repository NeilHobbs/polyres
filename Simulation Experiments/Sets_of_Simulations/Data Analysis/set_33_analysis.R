#Set 33:
#Mixtures, Rotations, Sequences with Cross Selection and refugia.
#Fitness costs not present..
library(ggplot2)
#read in the datasets:

mixtures.df = read.csv("Simulation Experiments/Sets_of_Simulations/Data from Simulations/mixtures.set.33.csv")
rotation.df = read.csv("Simulation Experiments/Sets_of_Simulations/Data from Simulations/rotation.set.33.csv")
sequence.df = read.csv("Simulation Experiments/Sets_of_Simulations/Data from Simulations/sequence.set.33.csv")
