...
###############################################################################################
library(polyres) #loads in ggplot2 and dplyr as dependencies
...
no.insecticides = c(rep(2, 2000), rep(3, 2000), rep(4, 2000))
df = cbind(df, no.insecticides)

freq.deployment = c(rep(5, 6000), rep(10, 6000), rep(20, 6000))#deployment decisions every 6, 12, 24 months
